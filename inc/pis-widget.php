...
class PIS_Posts_In_Sidebar extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		*/
		...
		if ( ! isset( $instance['the_more'] ) )             $instance['the_more']             = esc_html__( 'Read more&hellip;', 'posts-in-sidebar' );
		if ( ! isset( $instance['display_author'] ) )       $instance['display_author']       = false;
		if ( ! isset( $instance['author_text'] ) )          $instance['author_text']          = esc_html__( 'By', 'posts-in-sidebar' );
					...
					<div class="pis-container">
						...
						<div class="pis-column-container">
							...
							<div class="pis-column">
								...
								pis_form_input_text( esc_html__( 'URL of the default Gravatar image', 'posts-in-sidebar' ), $this->get_field_id( 'gravatar_default' ), $this->get_field_name( 'gravatar_default' ), esc_attr( $instance['gravatar_default'] ), 'http://example.com/image.jpg' ); ?>
					...
					<div class="pis-container">
						...
						<div class="pis-column-container">
							...
							<div class="pis-column">
								...
								<?php // ================= Hashtag
								pis_form_input_text( esc_html__( 'Use this hashtag', 'posts-in-sidebar' ), $this->get_field_id( 'hashtag' ), $this->get_field_name( 'hashtag' ), esc_attr( $instance['hashtag'] ), '#' ); ?>
