...
function pis_posts_in_sidebar( $args ) {
	...
	<?php if ( $cached && $pis_query ) { $pis_cache_activation = 'Cached version'; } ?>

	<?php echo '<!-- Generated by Posts in Sidebar v' . PIS_VERSION . ' - ' . $pis_cache_activation . ' -->'; ?>
