...
class PIS_Posts_In_Sidebar extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $title && isset( $instance['title_link'] ) ) {
		...
		if ( ! isset( $instance['intro_margin'] ) )         $instance['intro_margin'] = '';
		if ( ! isset( $instance['title_margin'] ) )         $instance['title_margin'] = '';
		if ( ! isset( $instance['side_image_margin'] ) )    $instance['side_image_margin'] = '';
		if ( ! isset( $instance['bottom_image_margin'] ) )  $instance['bottom_image_margin'] = '';
		if ( ! isset( $instance['excerpt_margin'] ) )       $instance['excerpt_margin'] = '';
		if ( ! isset( $instance['utility_margin'] ) )       $instance['utility_margin'] = '';
		if ( ! isset( $instance['categories_margin'] ) )    $instance['categories_margin'] = '';
		if ( ! isset( $instance['tags_margin'] ) )          $instance['tags_margin'] = '';
		if ( ! isset( $instance['terms_margin'] ) )         $instance['terms_margin'] = '';
		if ( ! isset( $instance['custom_field_margin'] ) )  $instance['custom_field_margin'] = '';
		if ( ! isset( $instance['archive_margin'] ) )       $instance['archive_margin'] = '';
		if ( ! isset( $instance['noposts_margin'] ) )       $instance['noposts_margin'] = '';
